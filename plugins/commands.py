    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                   InlineKeyboardButton("🗣️Movie 𝙶𝚛𝚘𝚞𝚙", url="https://t.me/ADMOVEIAD"),
                   InlineKeyboardButton("🤖 More botz", url="https://t.me/AD_BOTZ"),
                   InlineKeyboardButton("👨‍💻Source", url="https://github.com/LuciferMoringStarDevil/Unlimited-Filter-BotV2")
                ],
                [
                   InlineKeyboardButton("🔻 Join My Movie Groop 🔻", url="https://t.me/ADMOVEIAD")
                ]
            ]
        ),
...
async def help(client, message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🗣️𝙶𝚛𝚘𝚞𝚙", url="https://t.me/AD_BOTZ"),
            ...
            [
                [
                    InlineKeyboardButton(
                        "⛓️ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙾𝙳𝙴 ⛓️", url="https://github.com/LuciferMoringStarDevil/Unlimited-Filter-BotV2")
                ],
                [
